...
internal fun Path.drawBottomLeftTooltipShape(
    size: Size,
    radius: Float,
    ...
    // Draw right line
    lineTo(size.width, size.height - radius - pointerSize.height)
    ...
    // Draw bottom line
    lineTo(radius + pointerSize.width, size.height - pointerSize.height)

    // Draw pointer
    lineTo(radius + (pointerSize.width / 2f), size.height)
