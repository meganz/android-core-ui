...
/**
 * Runs [block] at most once per composition for the given [key].
 *
 * The execution is tied to the composition: if the composable leaves the composition and re-enters,
 * [block] will run again. Use [LaunchedOncePerAppEffect] if you want to share the execution across
 * the whole app process.
 * @param key Identifier for this effect. If the key changes during recomposition, the effect can run again.
 * @param block
 */
@Composable
